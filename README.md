...
Docker Desktop (or Docker Engine): Download from docker.com/products/docker-desktop. Ensure Docker is running in the background.

CLI Setup

Clone the Repository:

git clone https://github.com/SV592/repro-build.git
